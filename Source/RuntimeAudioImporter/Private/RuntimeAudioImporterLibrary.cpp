...
{
	USoundWave* SoundWaveRef = CreateImportedSoundWave();
...
bool URuntimeAudioImporterLibrary::FillRawWaveBuffer(USoundWave* SoundWaveRef, const FDecodedAudioStruct& DecodedAudioInfo)
{
...
void URuntimeAudioImporterLibrary::FillPCMBuffer(USoundWave* SoundWaveRef, const FDecodedAudioStruct& DecodedAudioInfo)
{
...
USoundWave* URuntimeAudioImporterLibrary::CreateImportedSoundWave() const
{
	return NewObject<USoundWave>();
}
...
void URuntimeAudioImporterLibrary::OnResult_Internal(USoundWave* SoundWaveRef, ETranscodingStatus Status)
{
