...
DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnAudioImporterResultNative, class URuntimeAudioImporterLibrary* RuntimeAudioImporterObjectRef, USoundWave* SoundWaveRef, ETranscodingStatus Status);

/** Dynamic delegate broadcast to get the audio importer result */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnAudioImporterResult, class URuntimeAudioImporterLibrary*, RuntimeAudioImporterObjectRef, USoundWave*, SoundWaveRef, ETranscodingStatus, Status);
...
public:
	 ...
	 * @param DecodedAudioInfo Decoded audio data
	 */
	static void FillPCMBuffer(USoundWave* SoundWaveRef, const FDecodedAudioStruct& DecodedAudioInfo);

	static bool FillRawWaveBuffer(USoundWave* SoundWaveRef, const FDecodedAudioStruct& DecodedAudioInfo);

protected:
	/** Creates a new instance of the ImportedSoundWave class to use */
	virtual USoundWave* CreateImportedSoundWave() const;
	 ...
	 */
	void OnResult_Internal(USoundWave* SoundWaveRef, ETranscodingStatus Status);
};
